...
import { FilterSearchDatacategorey } from "../../api/actions.js";
...
function Proudectssearchcategorey() {
  ...
  useEffect(() => {
    FilterSearchDatacategorey(setLoading, search, setData, setPerpage, setResults);
  }, [loading,search]);
...
export default Proudectssearchcategorey;