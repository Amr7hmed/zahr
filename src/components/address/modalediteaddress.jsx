...
import { EditeAddress, GetDataCity } from '../../api/actions';
...
function ModalEditeAddress(props) {
  ...
  const handleClick = (Id) => {
    if (state.name === "" ||
      ...
      setValidation(true);
      EditeAddress(setLoading, Id, state, clickedLatLng.lat, clickedLatLng.lng)
    }
  ...
  return (<div className="modal fade modaladdaddress"
    id={`modalediteaddress${Id}`} tabIndex="-1" aria-labelledby="modalediteaddressLabel" aria-hidden="true">
...
<div className="invalid-feedback">
        ...
        <div className="modal-footer">
          <button type="button" className="btn btn-save" onClick={() => handleClick(Id)} ata-bs-dismiss="modal">
