  ...
  return (<>
    {Rates.length === 0 ? "" :
      ...
      <div className='proudect__reviewslist'>
        ...
        {Rates.length === 1 ? <>
          <div className={"list"}>
            <ReviewItem Image={Rates[0].user.image} Title={Rates[0].user.name} Description={Rates[0].comment} Rate={Rates[0].rate}/>
          </div>
        </> : Rates.length === 2 ? <>
          <div className={"list"}>
            <ReviewItem Image={Rates[0].user.image} Title={Rates[0].user.name} Description={Rates[0].comment} Rate={Rates[0].rate}/>
            <ReviewItem Image={Rates[1].user.image} Title={Rates[1].user.name} Description={Rates[1].comment} Rate={Rates[1].rate}/>
          </div>
        ...
        {Rates.map(item=><>
          <ReviewItem Image={item.user.image} Title={item.user.name} Description={item.comment} Rate={item.rate} key={item.id}/>
        </>
        )}
        </div>
